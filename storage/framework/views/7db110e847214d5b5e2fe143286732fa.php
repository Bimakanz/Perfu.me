...
<script>
  ...
  function addSelectedToCart(evt) {
    ...
    // Memanggil fungsi global addToCart
    if (window.addToCart) {
      window.addToCart(productId, currentQty, evt || window.event, selectedSize, selectedPrice);
    } else {
      console.error("Fungsi addToCart tidak ditemukan. Pastikan file script cart/navbar sudah diload.");
      alert("Gagal menambahkan ke keranjang. Silakan muat ulang halaman.");
    }
  }
