...
<script>
  const ALL_PRODUCTS = [
    { id: 1, name: 'Vanessence', type: 'Eau de Parfum', gender: 'Wanita', variant: 'Gourmand Vanilla', size: '30ML', price: 150000, stock: 30, best_seller: true, image: '{{ asset("assets/images/vanessence.png") }}', tagline: 'Feminin, manis, dan memikat' },
    ...
    grid.innerHTML = products.map(p => `
      <div class="product-card">
        ...
        <div class="product-card-body">
          <div class="product-card-meta">${p.gender.toUpperCase()} &bull; ${p.variant.toUpperCase()}</div>
          ...
          <div class="product-card-actions">
            <a href="https://wa.me/6281234567890?text=Halo%2C%20saya%20ingin%20memesan%20${encodeURIComponent(p.name)}%20(${p.size})%20seharga%20${encodeURIComponent(formatPrice(p.price))}" target="_blank" rel="noopener" class="btn-card-wa">Pesan WhatsApp</a>
            <button class="btn-card-cart" onclick="window.addToCart(${p.id})" title="Masukkan ke Keranjang">
